...
data_dir = os.path.expanduser('~/CantusCerebra/data/SEED-VIG/Raw_Data')
labels_dir = os.path.expanduser('~/CantusCerebra/data/SEED-VIG/perclos_labels')
...
db = lmdb.open(os.path.expanduser('~/CantusCerebra/processed_data/SEED-VIG_processed_data'), map_size=6000000000)
