...
edf_path = os.path.expanduser('~/CantusCerebra/data/hmc_dataset/haaglanden-medisch-centrum-sleep-staging-database-1.1')
csv_folder = 'path/to/csv/recordings/'
output_path = os.path.expanduser('~/CantusCerebra/processed_data/HMC_processed_pkl_256Hz/')
