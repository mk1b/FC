...
# Path configurations
base_dir = os.path.expanduser("~/CantusCerebra/data/siena_dataset/siena-scalp-eeg-database-1.0.0")
patient_id = args.patient_id
output_dir = os.path.expanduser(f"~/CantusCerebra/processed_data/processed_siena/data_generate/{patient_id}")
